...
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Atlas: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 600000 blocks
    nSubsidy >>= (nHeight / 600000); // Atlas: 600k blocks

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Atlas: 5 minutes
static const int64 nTargetSpacing = 120; // Atlas: 2 minutes
...
{
    // Atlas: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "BBC News 19/12/2017 -  Derailed US train went 80mph into bend";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("35948b78676de5500464874024a4400e7a2de30b81274250529ca074fd2381e389ecff66c4571d9e421c414de77408b02ecaca6ab6914b5a4a93be4627688853bd") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513675447;
        block.nBits    = 488263869;
        block.nNonce   = 0;
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Atlas: increase each by adding 2 to bitcoin's value.
